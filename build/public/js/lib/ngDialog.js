...
(function (window, angular, undefined) {
	...
	module.provider('ngDialog', function () {
		...
		this.$get = ['$document', '$templateCache', '$compile', '$q', '$http', '$rootScope', '$timeout', function ($document, $templateCache, $compile, $q, $http, $rootScope, $timeout) {
			var $body = $document.find('body');

			var privateMethods = {
				onDocumentKeyup: function onDocumentKeyup(event) {
					if (event.keyCode === 27) {
						publicMethods.close();
					}
				},
...
//# sourceMappingURL=ngDialog.js.map
